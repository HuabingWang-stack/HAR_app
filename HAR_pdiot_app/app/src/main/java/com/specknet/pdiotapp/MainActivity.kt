...
import com.specknet.pdiotapp.live.LiveDataActivity5
...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var liveProcessingButton5: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        version = findViewById(com.specknet.pdiotapp.R.id.version)
        version.typeface = tf
        ...
        liveProcessingButton5 = findViewById(R.id.live_button5)
        liveProcessingButton.typeface = tf
        liveProcessingButton5.typeface = tf
        pairingButton = findViewById(R.id.ble_button)
        pairingButton.typeface = tf
    ...
    fun setupClickListeners() {
        ...
        liveProcessingButton5.setOnClickListener {
            val intent = Intent(this, LiveDataActivity5::class.java)
            startActivity(intent)
        }
