...
class LiveDataActivity : AppCompatActivity() {
    ...
    val INDEX_TO_NAME_MAPPING = mapOf(
        ...
        2 to "Desk work",
        3 to "Falling on knees",
        4 to "Falling on the back",
        5 to "Falling on the left",
        6 to "Falling on the right",
        ...
        12 to "Running",
        13 to "Sitting",
        14 to "Sitting bent backward",
        15 to "Sitting bent forward",
        16 to "Standing",
        17 to "Walking at normal speed"
    )
    var time = 0f
    ...
    private fun setTextInt(text: TextView, value: Float) {
        ...
        runOnUiThread {
            ...
            text.typeface = tf
            text.setTextSize(TypedValue.COMPLEX_UNIT_SP, 30F + 10F*value)
    ...
    private fun getDrawAble(a_max : Int): Drawable {
        ...
        when (a_max) {
            0 -> {
                drawable = resources.getDrawable(com.specknet.pdiotapp.R.mipmap.climbingstairs0)
            }
            1 -> {
                drawable =
                    resources.getDrawable(com.specknet.pdiotapp.R.mipmap.descendingstairs1)
            }
            2 -> {
                drawable = resources.getDrawable(com.specknet.pdiotapp.R.mipmap.deskwork2)
            }
            3 -> {
                drawable = resources.getDrawable(com.specknet.pdiotapp.R.mipmap.fallingonknees3)
            }
            4 -> {
                drawable =
                    resources.getDrawable(com.specknet.pdiotapp.R.mipmap.fallingontheback4)
            }
            5 -> {
                drawable =
                    resources.getDrawable(com.specknet.pdiotapp.R.mipmap.fallingontheleft5)
            }
            6 -> {
                drawable =
                    resources.getDrawable(com.specknet.pdiotapp.R.mipmap.fallingontheright6)
            }
            7 -> {
                drawable = resources.getDrawable(com.specknet.pdiotapp.R.mipmap.lyingdownleft7)
            }
            8 -> {
                drawable =
            ...
            9 -> {
                drawable =
                    resources.getDrawable(com.specknet.pdiotapp.R.mipmap.lyingdownonstomach9)
            }
            10 -> {
                drawable =
                    resources.getDrawable(com.specknet.pdiotapp.R.mipmap.lyingdownright10)
            }
            11 -> {
                drawable = resources.getDrawable(com.specknet.pdiotapp.R.mipmap.movement11)
            }
            12 -> {
                drawable = resources.getDrawable(com.specknet.pdiotapp.R.mipmap.running12)
            }
            13 -> {
                drawable = resources.getDrawable(com.specknet.pdiotapp.R.mipmap.sitting13)
            }
            14 -> {
                drawable =
                    resources.getDrawable(com.specknet.pdiotapp.R.mipmap.sittingbentforward14)
            }
            15 -> {
                drawable =
                    resources.getDrawable(com.specknet.pdiotapp.R.mipmap.sittingbentforward15)
            }
            16 -> {
